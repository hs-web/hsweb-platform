package org.hswebframework.web.platform;
...
@ComponentScan("org.hswebframework.web.platform")
@MapperScan(value = "org.hswebframework.web.platform", markerInterface = Dao.class) //扫描mybatis dao
